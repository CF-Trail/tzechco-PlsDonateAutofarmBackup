...
local Window = library:AddWindow("@szze | anyone from warsaw and is 18+ dm, paying 2k R$",
  {
	...
	for i, v in pairs(_boothlocation:WaitForChild('BoothUI'):GetChildren()) do
		if (v.Details.Owner.Text == "unclaimed") then
			...
			for i, v in ipairs(workspace.BoothInteractions:GetChildren()) do
		              if v:GetAttribute("BoothSlot") == _boothnum and (v.Position - mainCheckPosition).Magnitude < 100 then
